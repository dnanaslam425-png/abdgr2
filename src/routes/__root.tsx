...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    { name: 'keywords', content: 'مظلات سيارات, برجولات حدائق, بيوت شعر ملكية, تركيب مظلات, سواتر, هناجر, مظلات وسواتر, قرميد' },
      ...
      { property: "og:title", content: "نسيم الظل — للمظلات وسواتر وبرجولات الحدائق الحديثة" },
      ...
      { property: "og:image", content: "https://naseemalzil.com/assets/WhatsApp Image 2026-06-10 at 10.50.39 PM.jpeg" },
      { name: "twitter:image", content: "https://naseemalzil.com/assets/WhatsApp Image 2026-06-10 at 10.50.39 PM.jpeg" },
